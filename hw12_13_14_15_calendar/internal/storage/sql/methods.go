...
// Создать событие.
func (p *PgRepo) CreateEvent(ctx context.Context, event *hd.EventModel) (id int64, err error) {
	q := `
...
// Обновить событие.
func (p *PgRepo) UpdateEvent(ctx context.Context, event *hd.EventModel) error {
